    ...
    return (
      ...
      <section
        ...
        <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]'>
          ...
          <p className='mt-2 leading-relaxed text-gray-700 dark:text-white/70 text-[0.9rem]'>{ description }</p>
          <p className='mt-2 leading-relaxed text-gray-700 dark:text-white/70 text-[0.9rem]'><span className='underline'>Functional</span>: { functional }</p>
